<?php
    ...
    $querycheck = "select count(id) as c from `votes` where `torrentid`='$torrentid' and `userid`='$userid' and `hasvoted`='$do'";
    $querydelete = "delete from `votes` where `torrentid`='$torrentid' and `userid`='$userid' and `hasvoted`='$do'";
